...
$sql="select sub_categories.*,categories.categories from sub_categories,categories where sub_categories.categories_id=categories.id order by sub_categories.id desc";
